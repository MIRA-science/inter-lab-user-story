...
| [`artifacts/`](./artifacts/) | **The fleshed-out UX.** The user story as a narrative ([`ux-user-story.md`](./artifacts/ux-user-story.md)), five interactive HTML [`mockups/`](./artifacts/mockups/) with PNG previews, and a [`user-research-plan.md`](./artifacts/user-research-plan.md). Covers the three reception modes — import into a DG app, **view on the web with no DG app**, and request back. See [`artifacts/README.md`](./artifacts/README.md). |
